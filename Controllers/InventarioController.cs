...
namespace ProyectoTienda.Controllers
{
    public class InventarioController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_producto,cantidad_inventario,estatus")] Inventario inventario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_producto,cantidad_inventario,estatus")] Inventario inventario)
        {
            if (ModelState.IsValid)
            {
